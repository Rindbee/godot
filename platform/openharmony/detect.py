...
def get_opts():
    ...
    return [
        ...
        ("bundle_type", "Bundle type", get_default_bundle_type()),
...
def configure(env: SConsEnvironment):
    ...
    env["sign_material_dir"] = "/opt/config/keys"
    env["sign_pwd"] = "StorePassword"
    ...
    modules = [
        ...
        ModuleConfig("OH_CryptoRand", 21, True, "ohcrypto", None, True),
